...
export default Ember.Route.extend(AuthenticatedRouteMixin, {
  ...
  model(params) {
    ...
    .then(([profile, chartConfig]) => {
      return Ember.RSVP.all([chartConfig.get('properties'), profile.get('charts'), profile.get('chartSources'), profile.get('chartProperties')])
      .then(([chartPropConfigs, allCharts, allSourceConfigs, allPropConfigs]) => {
